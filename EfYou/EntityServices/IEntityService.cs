...
namespace EfYou.EntityServices
{
    public interface IEntityService<T> where T : class, new()
    {
        ...
        List<T> Get(List<object> ids, List<string> includes);
        List<T> Get(List<object> ids, List<string> includes, List<OrderBy> orderBys);
        T GetFirst(List<object> ids);
        T GetFirst(List<object> ids, List<string> includes);
        T GetFirst(List<object> ids, List<string> includes, List<OrderBy> orderBys);
        List<T> Get(List<object> ids, List<string> includes, List<OrderBy> orderBys, Paging paging);
        IQueryable<T> QueryableGet(IContext context, List<object> ids);
        IQueryable<T> QueryableGet(IContext context, List<object> ids, List<string> includes);
        IQueryable<T> QueryableGet(IContext context, List<object> ids, List<string> includes, List<OrderBy> orderBys);
        IQueryable<T> QueryableGet(IContext context, List<object> ids, List<string> includes, List<OrderBy> orderBys, Paging paging);
