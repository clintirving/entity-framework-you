...
namespace EfYouTests.EntityServices
{
    ...
    public class EntityServiceOfTTests
    {
        ...
        public void SetupConfigurationService()
        {
            ...
            _filterService.Setup(x => x.AddPaging(It.IsAny<IQueryable<DummyEntity>>(), It.IsAny<Paging>(), It.IsAny<IContext>(), It.IsAny<List<OrderBy>>()))
                .Returns<IQueryable<DummyEntity>, Paging, IContext, List<OrderBy>>((w, x, y, z) => w);
            ...
            _mockDbSet.Setup(x => x.AsNoTracking()).Returns(_mockDbSet.Object);
        }
        ...
        public void Get_CallsAddPagingOnFilterService()
        {
            ...
            // Assert
            _filterService.Verify(x => x.AddPaging(It.IsAny<IQueryable<DummyEntity>>(), It.IsAny<Paging>(), It.IsAny<IContext>(), It.IsAny<List<OrderBy>>()));
        }
        ...
        public void Get_Paging_CallsAddPagingOnFilterServiceWithPaging()
        {
            ...
            // Assert
            _filterService.Verify(x => x.AddPaging(It.IsAny<IQueryable<DummyEntity>>(), It.Is<Paging>(y => y == paging), It.IsAny<IContext>(), It.IsAny<List<OrderBy>>()));
        }
        ...
        public void Get_ReturnsFilteredContextDataSet()
        {
            ...
            // Act
            var results = _entityService.Get(new List<dynamic> {1});
        ...
        public void GetFirst_ReturnsFirstFromFilteredContextDataSet()
        {
            ...
            // Act
            var result = _entityService.GetFirst(new List<dynamic> {1, 2});
        ...
        public void Delete_CallsDeleteOnPermissionService()
        {
            ...
            // Act
            _entityService.Delete(new List<dynamic> {1});
        ...
        public void Delete_NoMatchingIds_DoesNotCallCascadeDelete()
        {
            ...
            // Assert
            _cascadeDeleteService.Verify(x => x.CascadeDelete(It.IsAny<List<dynamic>>()), Times.Never);
        }
